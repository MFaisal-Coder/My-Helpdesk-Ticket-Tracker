  ...
  return (
    <div className="relative">
      {ticketSubmitted ? (
        <div
          className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 
                  bg-green-50 px-16 py-14 rounded-xl shadow-xl font-medium 
      ...
      <div className="bg-white shadow-md rounded-md p-4 md:p-6 max-w-2xl mx-auto">
        <form action="" className="bg-gray-100 mt-4 rounded-md px-3 py-4">
          <div className="relative">
            <label
              htmlFor="name"
          ...
          <div className="mt-3 flex flex-col items-start sm:flex-row sm:items-center ml-0">
